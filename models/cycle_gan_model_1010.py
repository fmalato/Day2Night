...
class CycleGANModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.netG_A = unet.unet(feature_scale=4, n_classes=opt.output_nc, is_deconv=True, in_channels=opt.input_nc,
                                is_batchnorm=True, no_input=opt.no_input, gpu_ids=self.gpu_ids)
